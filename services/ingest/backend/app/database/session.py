...
def _engine_kwargs(database_url: str) -> dict:
    ...
    see tests/conftest.py's own separate sqlite engine). Split out as its own
    function (rather than inlined below) so the pool-selection logic itself
    is unit-testable without constructing a real engine.
    """
